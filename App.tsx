        ...
        <div className="max-w-3xl mx-auto px-4 h-16 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 md:gap-4">
            ...
            <a 
              ...
              className="flex items-center gap-2 px-3 py-1.5 bg-slate-900 text-white rounded-lg text-[10px] md:text-xs font-bold hover:bg-slate-800 transition-all shadow-sm active:scale-95"
            >
      ...
      <main className="max-w-3xl mx-auto px-4 py-6 md:py-16 flex-grow w-full">
        ...
        <div className="space-y-6 md:space-y-8 w-full min-w-0">
          <div className="bg-white rounded-3xl p-5 md:p-10 shadow-sm border border-slate-100 min-h-[400px] md:min-h-[500px] flex flex-col w-full">
            ...
            {/* Navigation */}
            <div className="mt-10 md:mt-12 flex items-center justify-between border-t border-slate-100 pt-6 md:pt-8">
              <button 
                onClick={() => setCurrentStepIdx(prev => Math.max(0, prev - 1))}
                disabled={currentStepIdx === 0}
                className="px-4 md:px-6 py-2 md:py-3 rounded-xl font-semibold text-slate-600 hover:bg-slate-100 disabled:opacity-0 transition-all flex items-center gap-2 text-sm md:text-base"
              >
              ...
              <button 
                ...
                className="px-5 md:px-8 py-2 md:py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-semibold shadow-lg shadow-blue-200 transition-all flex items-center gap-2 text-sm md:text-base"
              >
