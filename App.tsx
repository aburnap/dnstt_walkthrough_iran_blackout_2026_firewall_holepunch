      ...
      <header className="sticky top-0 z-40 w-full bg-white/80 backdrop-blur-md border-b border-slate-200">
        <div className="max-w-3xl mx-auto px-4 h-16 flex items-center justify-between">
          <div className={`flex items-center gap-2 ${isRtl ? 'flex-row-reverse' : 'flex-row'}`}>
            ...
            <h1 className="font-bold text-slate-800 tracking-tight text-sm md:text-base">DNSTT <span className="text-blue-600">{isRtl ? 'راهنما' : 'Guide'}</span></h1>
          </div>
        ...
        <div className="space-y-6 md:space-y-8 w-full min-w-0">
          <div className="bg-white rounded-3xl p-5 md:p-10 shadow-sm border border-slate-100 min-h-[400px] md:min-h-[500px] flex flex-col w-full">
            <div className="mb-6 md:mb-8">
              ...
              <p className="text-slate-500 text-base md:text-lg">{metadata.description[lang]}</p>
            </div>
